...
public class Session {
     ...
     * List of muted users.
     */
    private final List<ParkourUser> muted = Collections.synchronizedList(new ArrayList<>());

    /**
     * List of users (Folia: 使用 ConcurrentHashMap 保证线程安全).
     */
    private final Map<UUID, ParkourUser> users = new ConcurrentHashMap<>();
